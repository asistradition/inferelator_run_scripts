...
MPControl.client.add_worker_conda("source ~/.local/anaconda3/bin/activate scenic")
...
class DownsampleDataWorkflow(workflow._factory_build_inferelator(regression=SCENICRegression, workflow=SCENICWorkflow)):
...
if __name__ == '__main__':
    ...
    with open(os.path.join(OUTPUT_PATH, "downsample_performance_genie3.tsv"), "a+") as out_fh:
        ...
        for ratio in [0.005, 0.01, 0.1, 1.0]:
            ...
            for seed in range(42, 52):
                ...
                MPControl.client.client.restart()
                gc.collect()
