...
PRIOR_FILES = edge_files = {"BOTH_CISBP": 'BOTH_CISBP_200_50.tsv.gz',
                            "BOTH_JASPAR": 'BOTH_JASPAR_200_50.tsv.gz',
                            "BOTH_TRANSFAC": 'BOTH_TRANSFAC_200_50.tsv.gz',
                            "INTERSECT_CISBP": 'INTERSECT_CISBP_200_50.tsv.gz',
                            "INTERSECT_JASPAR": 'INTERSECT_JASPAR_200_50.tsv.gz',
                            "INTERSECT_TRANSFAC": 'INTERSECT_TRANSFAC_200_50.tsv.gz',
                            "YEASTRACT": YEASTRACT_PRIOR}

INPUT_DIR = '/mnt/ceph/users/cjackson/inferelator/data/yeast'
OUTPUT_PATH = '/mnt/ceph/users/cjackson/gsj_2020_fig2_joint'
...
if __name__ == '__main__':
    ...
    for expt_name, prior_file in PRIOR_FILES.items():
        ...
        set_up_workflow(worker)
        worker.set_file_paths(priors_file=prior_file)
        worker.append_to_path('output_dir', expt_name + "_shuffle")
