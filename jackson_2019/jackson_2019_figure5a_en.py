...
if __name__ == '__main__':
    ...
    worker.workflow.set_regression_parameters(min_coef=0.01)
    ...
    worker = ws.set_up_fig5a(regression="elasticnet")
    worker.workflow.set_regression_parameters(min_coef=0.01)
    worker.append_to_path('output_dir', 'en_figure_5a_shuffled')
    ...
    worker = ws.set_up_fig5a(regression="elasticnet")
    worker.workflow.set_regression_parameters(min_coef=0.01)
    worker.append_to_path('output_dir', 'en_figure_5a_magic')
    ...
    worker.workflow.set_regression_parameters(min_coef=0.01)
    worker.append_to_path('output_dir', 'en_figure_5a_scImpute')
